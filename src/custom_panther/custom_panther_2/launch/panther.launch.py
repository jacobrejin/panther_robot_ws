...
def generate_launch_description():
    ...
    # # Include the launch file that defines the transformation between the camera and the robot
    # # this is required to as the gazebo is not publishing correct tf for the camera
    # transform_custom = IncludeLaunchDescription(
    #     PythonLaunchDescriptionSource(
    #         PathJoinSubstitution(
    #             [
    #                 FindPackageShare("test_custom_panther_cam"),
    #                 "launch",
    #                 "transform_custom.launch.py",
    #             ]
    #         )
    #     ),
    # )
